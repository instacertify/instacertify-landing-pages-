...
const EMPTY_CONTENT = {
  ...
  // Complete page chrome — editable for every lead-gen design
  ...
  formServicePlaceholder: "Select Certification Type",
  formMessagePlaceholder: "Product / brand / requirement",
...
function pageParams(input, slug, existing = null) {
  ...
  return {
    ...
    design: pick(input.design, existing?.design, "service"),
